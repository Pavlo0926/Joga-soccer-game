...
public class MenuController : MonoBehaviour {
	...
	//private float buttonAnimationSpeed = 9;		//speed on animation effect when tapped on button< unused > FST
		...
		if (Physics.Raycast(ray, out hitInfo)) {
			...
			switch(objectHit.name) {
				...
				case "gameMode_1":								//player vs AI mode
                    ...
                    FST_SettingsManager.MatchType = 0;			//set game mode to fetch later in "Game" scene
				...
				case "gameMode_3":
					playSfx(tapSfx);
                    FST_SettingsManager.MatchType = 0;
