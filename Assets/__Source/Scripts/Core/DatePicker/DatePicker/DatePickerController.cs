...
namespace FantomLib
{
    ...
    public class DatePickerController : MonoBehaviour
    {
        ...
        public string resultDateFormat = "dd-MM-yyyy";    //Java Datetime format.
        ...
        public void Show()
        {
            ...
            JiwemanRegisterdataManager.SharedInstance.DOB_txt.text = "12-12-1990";
#elif UNITY_ANDROID
        ...
        private void ReceiveResult(string result)
        {
            if (OnResult != null) {
                ...
                JiwemanRegisterdataManager.SharedInstance.DOB_txt.text = result;
            }
        }
    }
}
