...
//					used instead of FST_Timer for syncing current game time across
//					several physical machines, since FST_Timer will pause when unity
//					freezes (such as when dragging game window around on desktop)
//
/////////////////////////////////////////////////////////////////////////////////

public static class FST_MPClock
{
