...
{
    public static Player2Controller Instance;//note: remove these and make ref to arrow plane itself. this is wasteful
    ...
    //real distance of our touch/mouse position from initial drag position
    private float currentDistance;
    //A safe distance value which is always between min and max to avoid supershoots
    ...
    private Renderer BallRender { get { if (!m_BallRender) m_BallRender = FST_BallManager.Instance.GetComponent<Renderer>(); return m_BallRender; } }
    ...
    void Awake()
    {
     ...
     //   CanShoot = true;
        ...
        currentDiscMaterial = MeshCol.material;

        GetRigidbody.maxAngularVelocity = 360;
    }
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        //Debug.Log("disk 2 force: " + force + " / AVG = " + AverageMaxMinCols()[0] + " / MAX = " + AverageMaxMinCols()[1] + " / MIN = " + AverageMaxMinCols()[2]);
        ...
        {
           // Debug.Log("SEND COLLISION EVENT 2!");
        ...
        switch (other.gameObject.tag)
        {
            ...
            case "Player":
              ...
              //  Comment1();// all commented stuff in here for cleanliness, when used can simply move it back here ->FST
                break;
            ...
            case "Player_2":
              ...
              //  Comment2();// all commented stuff in here for cleanliness, when used can simply move it back here ->FST
...
/*        Vector3 orthogonalVector = other.contacts[0].point - transform.position;
        ...
        /* float force = other.relativeVelocity.magnitude * Time.fixedDeltaTime;
         Vector3 impactVector = other.contacts[0].normal * force * FST_Physics.DiskToDiskForceMultiplier;
         other.rigidbody.AddForce(new Vector3(-impactVector.x, -impactVector.y, 0));*/
        //other.rigidbody.AddForceAtPosition(other.rigidbody.velocity * FST_Physics.DiskToDiskForceMultiplier, other.GetContact(0).point);
    ...
    /*
        public void UpdateStatsValue()
        {
            ...
            InGameTime_Percentage.fillAmount = timeplayer2 / BumpStaminaManager.instance.initialvalueTime;
    ...
    */
    ...
    public void PlayerMouseDrag()
    {
        ...
        ChildMeshRender.sortingOrder = 3;
        MeshRender.sortingOrder = 2;
        BallRender.sortingOrder = 2;
    ...
    private IEnumerator AssignPlayer()
    {
        ...
        GlobalGm.Current2Player = GetRigidbody;
    ...
    void Comment1()
    {
        /*
                  ...
                  if (gameObject.GetComponent <PlayerStats> ().PrimaryAttackingDisc && GlobalGameManager.players2Turn) {
...
//				}
                        ...
                        Debug.LogError ("player elephant DirectOpponentDisc");
                  } else if (gameObject.GetComponent <PlayerStats> ().SecondaryAttackingDisc && GlobalGameManager.players2Turn) {
...
//				}
                        ...
                        Debug.LogError ("player elephant FirstIndirectOpponentDisc");
                  } else if ((gameObject.GetComponent <PlayerStats> ().FirstIndirectOpponentDisc || gameObject.GetComponent <PlayerStats> ().DirectOpponentDisc || gameObject.GetComponent <PlayerStats> ().SecondaryIndirectOpponentDisc) && GlobalGameManager.playersTurn) {
...
//				}
                        ...
                        Debug.LogError ("player elephant SecondaryIndirectAttackingDisc");
                  } else if (gameObject.GetComponent <PlayerStats> ().SecondaryIndirectAttackingDisc && GlobalGameManager.players2Turn) {
...
//				}
                        ...
                        Debug.LogError ("player elephant SecondaryIndirectOpponentDisc");
                  }
    ...
    void Comment2()
    {
        /*
                                         ...
                                         if (gameObject.GetComponent <PlayerStats> ().PrimaryAttackingDisc) {
                                               ...
                                               gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (other.gameObject.name);
                                               other.gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (gameObject.name);
                                               Debug.LogError ("player2 elephant SecondaryAttackingDisc");
                                               ...
                                               other.gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (gameObject.name);
                                               gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (other.gameObject.name);
                                               Debug.LogError ("player2 elephant SecondaryAttackingDisc111");
                                               ...
                                               other.gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (gameObject.name);
                                               gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (other.gameObject.name);
                                               Debug.LogError ("player2 elephant SecondaryIndirectOpponentDisc");
                                               ...
                                               other.gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (gameObject.name);
                                               gameObject.GetComponent <PlayerStats> ().touchDiscName.Add (other.gameObject.name);
                                               Debug.LogError ("player2 elephant FirstIndirectOpponentDisc");
